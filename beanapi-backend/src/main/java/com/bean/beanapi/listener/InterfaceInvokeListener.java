package com.bean.beanapi.listener;
...
import static com.bean.beanapicommon.constant.RabbitmqConstant.QUEUE_INTERFACE_CONSISTENT;
...
public class InterfaceInvokeListener {
    ...
    //监听queue_interface_consistent队列，实现接口调用次数回滚功能
